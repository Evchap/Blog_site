...
#     paginate_by = 3
    ...
    def get_queryset(self):
        return Musicians.objects.filter(is_published=True).select_related('cat')
...
#     paginate_by = 2
    ...
    def get_queryset(self):
        return Musicians.objects.filter(cat__slug=self.kwargs['cat_slug'], is_published=True).select_related('cat')
